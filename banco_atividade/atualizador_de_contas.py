...
from heranca1 import Conta, ContaCorrente, ContaPoupanca
...
if __name__ == '__main__':
    # c = Conta('123-4', 'Joao', 1000.0, 200)
    # cc = ContaCorrente('123-5', 'Jose', 1000.0, 300)
    # cp = ContaPoupanca('123-6', 'Maria', 1000.0, 400)
